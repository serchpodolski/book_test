...
def lr_predict(var_1, var_2, var_3, var_4, var_5):
    preds = np.array([var_1, var_2, var_3, var_4, var_5]).reshape(1,-1).astype(int)
...
def run():
    ...
    if streamlit.button('Predict'):
        prediction=lr_predict(var_1, var_2, var_3, var_4, var_5)
